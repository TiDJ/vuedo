 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Media listing($relations = 'owner', $perPage = 10)
 */
class Media extends MediaModel
{
    use  HashOrSlugScope;
    // Sluggable, 
    protected $fillable = ['name', 'icon', 'alt', 'description', 'title', 'collection_name'];
