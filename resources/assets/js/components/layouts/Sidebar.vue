            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a v-link="{ path: '/posts/' }"><i class="fa fa-tasks"></i>Posts list</a></li>
                        <li><a @click="createPost" href="#"><i class="fa fa-plus"></i>New post</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-th-large"></i> <span>Categories</span> <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a v-link="{ path: '/categories/' }"><i class="fa fa-list"></i>Categories list</a></li>
                        <li><a @click="createCategory" href="#"><i class="fa fa-plus"></i>New category</a></li>
                    </ul>
                </li>
                <li><a v-link="{ path: '/users/' }"><i class="fa fa-users"></i> <span>Users</span></a></li>
                <li><a v-link="{ path: '/medias/' }"><i class="fa fa-upload"></i> <span>Uploads</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
